...
export default function UnauthorizedPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-ink-50 dark:bg-ink-800 px-4 text-center">
      <ShieldAlert size={40} className="text-signal-rose" />
      <h1 className="text-lg font-semibold text-ink-900 dark:text-ink-50">You don't have access to this page</h1>
